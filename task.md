...
- **Status:** オーナー就寝中の自走。**公開サイトと admin の見直し／選べる範囲の拡張／
  違和感の修正**。commit 38本が push 待ち
- **Current owner:** Claude Code / **Handoff readiness:** ready
- **Branch:** `main` / **HEAD:** `SELF` / **Git:** clean・未追跡なし / **origin より 38 先**
...
### 使用感・見た目（オーナー指示で着手）
- **公開4ページの左右余白が 16/24/20/24px** とばらばらで、移動のたび本文が横へ
  ずれていた。`.site-page` で 24/48px に統一
