...
**A層 288行 → 241行（−47）。**内訳は `AGENTS.md` 148→110、`CLAUDE.md` 64→55、
`file-hygiene.md` 18（変更なし）、Current State 58（変更なし）。
§6-A の見積り235行との差6行は、Current State が58行（55の見積りに対し）、
`CLAUDE.md` が55行（53に対し）、`AGENTS.md` が110行（109に対し）であるため。
