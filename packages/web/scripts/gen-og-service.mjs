...
const serviceSvg = `<svg width="${W}" height="${H}" viewBox="0 0 ${W} ${H}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="${W / 2}" y="248" text-anchor="middle" font-family="Georgia, 'Times New Roman', serif" font-size="30" letter-spacing="9" fill="#a39c92">AKI EGUCHI</text>
  <text x="${W / 2}" y="350" text-anchor="middle" font-family="Georgia, 'Times New Roman', serif" font-size="66" letter-spacing="10" fill="#2c2824">PORTFOLIO KIT</text>
