...
使い方: **1セッション=1枚**。下の指示書を丸ごとコピーして Claude Code (Sonnet) に貼る。
...
## Q-2. 既存写真に壊れキーが無いかの点検（読み取りのみ） [夜間ラン可]
...
## Q-4. ヒーロー/プロフィール画像差し替え時の旧ファイル掃除 [昼推奨] [要オーナー判断] [Codexレビュー必須]
...
## Q-5. /admin/settings のキー許可リスト [Codexレビュー必須]
...
## Q-7. 公開ページの text-xs をトークンに統一（約30箇所） [夜間ラン可]
...
## Q-8. Contact フォームラベルの日本語化（1-e） [昼推奨] [要オーナー判断]
...
## Q-9. footerCtaLabel / About→Gallery 導線 [要オーナー判断]
...
## Q-10. Lightbox キャプションの佇まい2案モック [要オーナー判断]
