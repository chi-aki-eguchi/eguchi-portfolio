...
- **Status:** オーナー就寝中の自走。**公開サイトと admin の見直し／選べる範囲の拡張／
  違和感の修正**。commit 34本が push 待ち
- **Current owner:** Claude Code / **Handoff readiness:** ready
- **Branch:** `main` / **HEAD:** `SELF` / **Git:** clean・未追跡なし / **origin より 34 先**
...
- `homeStatement` TOPに作家の言葉（文章は Profile のものを再利用）
- `viewerStyle` 写真ビューアの壁 = 白い展示壁／暗室／生成りの紙（オーナー承認済み）
...
- `bun run check` 896 pass / 0 fail・`bun run smoke` 307 passed / 0 failed（直近3回とも）
