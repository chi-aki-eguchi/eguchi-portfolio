import { PAGE_TITLE } from "./site-title";
...
export const PORTFOLIO_DISCOVERY_GUIDE = {
  "title": PAGE_TITLE.portfolioGuide,
  "author": "江口秋",
  "description": "写真ポートフォリオを初めて作る方へ。紙・PDF・Webの使い分け、10〜20枚からの写真選び、構成例、制作費と維持費、公開までの手順を写真家・江口秋が解説します。",
  "summary": [
  ...
  "sections": [
    {
      "id": "format",
      "title": "紙・PDF・Webを、見せる場面で使い分ける",
      "body": [
        "ポートフォリオは、自分が何を撮る人なのかを伝えるために選び、順番を考えた作品集です。写真をすべて並べる前に、相手がどこで見るかを決めます。応募先から枚数・形式の指定がある場合は、その指定を優先してください。",
        "紙の作品集：対面で見せるときに向いています。見開きの組み合わせ、紙の質感、印刷したときの大きさも表現の一部になります。更新には刷り直しが必要なので、まず小さく試し刷りして順番と明るさを確かめます。",
        "PDF：メールや応募フォームで、相手に合わせた作品だけを渡したいときに使えます。表紙・作品・プロフィール・連絡先をまとめ、送付先の容量上限とページ数を確認します。スマホでも読める文字サイズにし、連絡先のリンクが開くか試してください。",
        "Webサイト：SNSのプロフィール、名刺、検索から、いつでも最新作を見てもらう入口です。作品ごとのURLを渡せて、公開後も写真や文章を更新できます。紙やPDFと併用し、そちらにもサイトのURLを添えると、後から新作を見てもらえます。",
        "この先は、Webサイトを作る手順を中心に、紙やPDFにも使える写真選びと構成を説明します。最初からすべてを作る必要はありません。今、誰に何を渡したいかに合わせて選んでください。"
      ]
    },
    {
      "id": "target",
    ...
    {
      "id": "example",
      "title": "人物写真を見せるポートフォリオの構成例",
      "body": [
        "人物の撮影を頼んでほしい場合の仮の構成です。トップには代表写真と、名前・活動地域・撮影分野を短く。次に、ひとつの撮影から数枚をまとめた作例を置きます。顔に寄った写真だけでなく、全身や周囲との関係が分かる写真も比べ、残したい印象に沿って選びます。",
        "作品ページには題名と短い背景を添えます。自主制作ならそのことを明記し、依頼された撮影と混同させません。被写体や関係者の名前を掲載する場合は、公開してよい情報か確かめてください。",
        "プロフィールでは、経歴の長さよりも、現在の活動と撮影への考え方を自分の言葉で伝えます。問い合わせには「用途・希望日・場所・予算を分かる範囲で」と添え、作品を見終えた場所からそのまま相談へ進めるようにします。"
      ],
      "checklist": [
        "トップ：代表写真／名前／撮影分野と地域",
        "作品：撮影やテーマごとのまとまり／短い説明",
        "プロフィール：現在の活動／撮影への考え方",
        "問い合わせ：用途・日程・場所・予算の相談先"
      ]
    },
    {
      "id": "approach",
