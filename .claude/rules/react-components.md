...
ギャラリーレイアウトは mosaic / grid / scroll / stagger / editorial / collage / clean-grid / masonry / large-format の9種のみ。未知の値は mosaic にフォールバック。freeform / polaroid / timeline / fullbleed / compare は削除済み — 復活させない。
